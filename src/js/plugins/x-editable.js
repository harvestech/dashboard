...
(function ($) {
    ...
    */      
    $.fn.editableform.template = '<form class="form-inline editableform" style="margin: 3px 3px 3px 3px;">'+
...
(function ($) {
    ...
    $.fn.editableform.buttons = 
      '<button type="submit" class="btn btn-primary btn-sm editable-submit">'+
        '<i class="nc-icon icon-ok" aria-hidden="true"></i>'+
      '</button>';
      //+
      //'<button type="button" class="btn btn-default btn-sm editable-cancel">'+
      //  '<i class="nc-icon icon-cancel-1" aria-hidden="true"></i>'+
      //'</button>';         
